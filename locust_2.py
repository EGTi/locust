...
class MyTaskCase(TaskSet):
    ...
    def login_(self):
        url = '/api/public/core/login'  # 接口请求的URL地址
    ...
    def getuser_(self):
        url = '/api/public/core/getUserCity'  # 接口请求的URL地址
